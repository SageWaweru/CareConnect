  ...
  return (
    <div className="min-h-screen bg-beige py-10 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <div
          role="button"
          className="float-right text-2xl text-coral hover:text-emerald-800 transition"
        ...
        <p className="text-gray-700 text-lg">
          <strong className="text-emerald-700">Rate:</strong> Ksh {profile.rate} per {profile.rate_type} and {profile.user}
        </p>
...
//     <div className="min-h-screen bg-beige py-10 px-4">
//       <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
//       <div role="button" className="float-right text-2xl text-coral hover:text-emerald-800 transition"  onClick={() => navigate(`/caretakers`)}>✖</div>   
//         <img
//           src={profile.profile_picture}
//           alt="Profile"
//           className="w-40 h-40 object-cover rounded-full mb-4"
...
//         </p>
//         <p className="text-gray-700 text-lg">
//           <strong className="text-emerald-700">Rate:</strong> Ksh {profile.rate}{" "}
//           per {profile.rate_type}
//         </p>
//         <p className="text-gray-700 text-lg flex">
//           <strong className="text-emerald-700">Ratings:</strong> <p className="mt-1"> <StarRating rating={averageRating} /></p>
//         </p>
//         <button onClick={handleReviewClick} className="mt-4 px-4 w-1/3 py-2 h-18 text-white bg-coral hover:bg-emerald-800 hover:text-white transition rounded-lg">
//          Rate Caretaker
//         </button>
//         <button className="mt-4 px-4 py-2 w-1/3 ml-2 text-white bg-coral hover:bg-emerald-800 hover:text-white transition rounded-lg" 
//          onClick={() => navigate(`/caretaker/${profile.id}/reviews`)}>
//          View Reviews
//         </button>
//         <button onClick={() => setChatOpen(true)}>Chat</button> {chatOpen && <Chat caregiverId={id} />}
//       </div>
//     </div>
//   );
// };
