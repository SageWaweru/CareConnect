...
from .serializers import UserRegistrationSerializer, UserSerializer, ReviewSerializer,CaretakerProfileSerializer, ChatMessageSerializer, ReplySerializer, JobApplicationSerializer, JobPostSerializer, VocationalSchoolSerializer, CourseSerializer, EnrollmentSerializer
